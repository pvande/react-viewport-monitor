...
var ViewportMonitor = function (_React$PureComponent) {
  ...
  function ViewportMonitor(props, collector, events) {
    ...
    _this.events = events;
    _this.state = (0, _viewport2.default)();
    return _this;
  }
  ...
  _createClass(ViewportMonitor, [{
    ...
    value: function render() {
      var props = _extends({}, this.props, this.collector(this.state, this.props));
      return _react2.default.createElement(this.constructor.DecoratedComponent, props);
    }
  }]);
